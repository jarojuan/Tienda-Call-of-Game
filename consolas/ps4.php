...
<head>
    ...
    <!--Icono de pestaña-->
    <link rel="icon" href="../iconos/playstation-brands.svg">
    ...
    <div  class="p-3 mb-2 bg-info text-white">
        <div class="container">
            ...
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">PS4 <i class="fa-brands fa-playstation"></i></i></h1>
                    <h2>Bienvenido a Play Station</h2>
