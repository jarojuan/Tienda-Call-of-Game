...
<head>
    ...
    <title>SWITCH | Call of Game</title>
    ...
    <!--Icono de pestaña-->
    <link rel="icon" href="../iconos/nintendo_switch_icon.svg">
    ...
    <div  class="p-3 mb-2 bg-info text-white">
        <div class="container">
            ...
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">SWITCH <i class="fa-solid fa-gamepad"></i></h1>
                    <h2>Bienvenido a Nintendo Switch</h2>
            ...
            <div class="row">
                ...
                $info_juegos = $juego->mostrarSWITCH();
